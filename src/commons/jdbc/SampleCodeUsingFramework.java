...
import commons.jdbc.exception.DatabaseException;
...
public class SampleCodeUsingFramework
{
	...
	static String sqlSelect = "SELECT TEST_ID, NOTES, TEST_DT, AMOUNT, CODE " +
	"FROM JDBC_TEST " +
	"WHERE TEST_ID < ? " +
	"AND TEST_DT < ? " +
    ...
    connURL = "jdbc:hsqldb:file:C:\\Documents and Settings\\jssmith\\.portal-files\\portal";
    username = "sa";
    password = null;
	}
	...
	public static void testStandardJDBC()
	{
		...
		catch (SQLException sqle)
		{
			...
			case 1:
			case 1407: 
			case 1722: applyDataIntegrityViolationRecovery();
			}
		}
...
//			sqlExec.addParam(new Integer(8));
	...
	public static void testOracleStoredFunction()
	{
		...
		if (res.getRowCount() > 0)
			System.out.println("SQL Results: " + res.getInt(0, 0));
	}
	...
	public static void testDeleteAndInsert()
	{
		...
		String sql = "INSERT INTO JDBC_TEST (TEST_ID, NOTES, TEST_DT, AMOUNT, CODE) " +
...
//		"VALUES (7, 'seven', CURRENT_DATE, 25.245, 'E')";  MySQL version
	...
	public static void testDeadlockException()
	{
		...
		catch (DatabaseException e)
		{
			...
			if (e.isRowlockOrTimedOut())
				System.out.println("Rowlock exception!");
		}
		finally
		{            
	...
	public static void testSelectDistinctAndMixedCase()
	{
		...
		String sql = "SELECT distinct test_id, test_dt " +
		"FROM JDBC_TEST " +
